...
class TestValidateIranianPhoneNumber:
    """Unit tests for validate_iranian_phone_number."""
...
class TestPhoneValidatorIntegration:
    """Integration tests ensuring phone validation works end-to-end."""

    def test_create_user_rejects_invalid_phone(self):
        """sad path: create_user rejects a non-Iranian phone number at model level."""
    ...
    def test_register_api_rejects_invalid_phone(self, api_client, register_url):
        """sad path: register API rejects a non-Iranian phone number with 400."""
