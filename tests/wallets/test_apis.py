...
class TestWalletDefineApi:
    ...
    def test_creates_wallet_successfully(self, authenticated_api_client, wallet_define_url):
        """happy path: creates a wallet and returns 201 with wallet data."""
        payload = {"currency": "USD", "initial_balance": "50.00"}

        response = authenticated_api_client.post(wallet_define_url, payload, format="json")
    ...
    def test_creates_wallet_without_initial_balance(self, authenticated_api_client, wallet_define_url):
    ...
    def test_rejects_duplicate_currency(self, authenticated_api_client, wallet_define_url, usd_wallet):
    ...
    def test_rejects_invalid_currency(self, authenticated_api_client, wallet_define_url):
    ...
    def test_rejects_negative_initial_balance(self, authenticated_api_client, wallet_define_url):
    ...
    def test_requires_authentication(self, wallet_define_url):
        ...
        response = client.post(wallet_define_url, {"currency": "USD"}, format="json")
...
class TestWalletMyApi:
    ...
    def test_returns_user_wallets(self, authenticated_api_client, wallet_my_url, usd_wallet, eur_wallet):
    ...
    def test_excludes_other_users_wallets(self, authenticated_api_client, wallet_my_url, usd_wallet, other_user):
    ...
    def test_returns_empty_when_no_wallets(self, authenticated_api_client, wallet_my_url):
